...
public class FilterCorporateData implements Filter<List<CorporateEntity>> {
    ...
    public FilterCorporateData(CorporateRepository corporateRepository, TradeHistoryRepository tradeHistoryRepository) {
        this.corporateRepository = corporateRepository;
        this.tradeHistoryRepository = tradeHistoryRepository;
    }

    public List<CorporateEntity> execute(List<CorporateEntity> input) throws IOException {
        List<CorporateEntity> companies = new ArrayList<>();
